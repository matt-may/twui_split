...
Component category and name: marketing / page-examples / landing-pages / With mobile screenshot and testimonials grid

Component summary: This is a comprehensive landing page component featuring a mobile screenshot and testimonials grid layout. The component combines several key sections including a hero area with a mobile device mockup, feature highlights, testimonial grid, and newsletter signup, all thoughtfully structured with responsive design patterns. Notable technical aspects include a responsive navigation system with mobile menu support using Headless UI's Dialog component, decorative SVG patterns for visual interest, and a complex testimonials grid that adapts its layout across different breakpoints using Tailwind's grid utilities.

The component demonstrates advanced layout techniques including the use of absolute positioning for decorative elements, complex grid structures for testimonial cards, and careful attention to typography and spacing. It would be particularly useful for SaaS or mobile app landing pages where showcasing a product screenshot alongside social proof and feature highlights is crucial for conversion.

Key features include:
- Responsive navigation with mobile menu
- Hero section with mobile device mockup
- Feature grids with icons
- Testimonial grid with featured testimonial
- Newsletter signup sections
- Comprehensive footer with multi-column layout
- Social media integration
- Decorative background patterns using SVG
*/
/*
...
Component category and name: marketing / page-examples / landing-pages / With screenshots and stats

Component summary: This is a comprehensive dark-themed landing page component designed for SaaS/cloud deployment platforms, featuring a sophisticated layout that combines marketing elements with visual hierarchy. The component includes multiple sections: a hero with an app screenshot, logo cloud for social proof, feature highlights with icons, statistics display, and a call-to-action section, all unified by a consistent dark color scheme with indigo accents. The implementation uses advanced Tailwind CSS patterns for background effects, gradients, and responsive layouts, while incorporating HeroIcons for visual elements and maintaining accessibility through semantic HTML structure.

Key technical features include:
- Responsive grid layouts that adapt across different screen sizes
- Complex SVG patterns and gradients for visual interest
- Systematic spacing and typography scale using Tailwind's utility classes
- Interactive elements like buttons and links with hover states
- Organized content structure with primary/secondary features and statistics

This component would be particularly useful for modern tech companies, SaaS platforms, or cloud services looking to create a professional, feature-rich landing page with strong visual hierarchy and clear call-to-actions.
*/
import {
  ArrowPathIcon,
  ChevronRightIcon,
...
Component category and name: marketing / page-examples / pricing-pages / With comparison table

Component summary: This is a comprehensive pricing page component with a detailed feature comparison table. The component implements a sophisticated pricing interface with three tiers (Starter, Scale, and Growth) and includes both monthly and annual billing options. The layout features a responsive design that adapts between mobile and desktop views, using a grid-based comparison table for larger screens and a more compact list view for mobile devices.

The component's structure includes:
- A header with mobile-responsive navigation
- A hero section with pricing tier cards and a billing frequency toggle
- A detailed feature comparison section that switches between two different layouts based on viewport size
- An FAQ section
- A full-featured footer with social links and navigation categories

The implementation notably uses the Headless UI library for interactive elements like the radio group selector and dialog components, combined with careful styling using Tailwind CSS for visual hierarchy and responsive behavior. The component employs sophisticated state management for handling the billing frequency selection and mobile menu visibility.
*/
'use client'
...
Component category and name: marketing / page-examples / pricing-pages / With four tiers

Component summary: This is a comprehensive pricing page component featuring four distinct pricing tiers with a toggle between monthly and annual billing frequencies. The component implements a sophisticated layout that includes a responsive navigation header, pricing cards with feature lists, a logo cloud section, testimonials, FAQs using the Headless UI Disclosure component, and a detailed footer structure. It's particularly well-suited for SaaS or subscription-based services that need to showcase multiple pricing options with varying feature sets while maintaining a professional and cohesive design through supporting sections that build trust and answer common questions.

The pricing cards themselves use a clean grid layout that highlights the most popular plan with a distinctive border, and each tier includes clear pricing information, feature lists with checkmark icons, and prominent call-to-action buttons. The mobile-responsive design includes a hamburger menu for smaller screens and adjusts the grid layout appropriately, making it a complete solution for presenting pricing information across all device sizes.
*/
'use client'
